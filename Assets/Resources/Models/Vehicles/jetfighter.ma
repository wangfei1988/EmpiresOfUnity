...
//Name: Jäger.ma
//Last modified: Mon, Mar 31, 2014 02:21:01 PM
//Codeset: 1252
requires maya "2014";
...
createNode transform -s -n "persp";
	setAttr ".v" no;
	setAttr ".t" -type "double3" 46.921062193356356 13.672286942325057 3.9259158564979413 ;
	setAttr ".r" -type "double3" -10.538352674398368 -990.99999999990393 4.5560402990818518e-014 ;
...
createNode camera -s -n "perspShape" -p "persp";
	...
	setAttr ".coi" 48.800040083439384;
...
createNode transform -n "pCube1";
	setAttr ".t" -type "double3" 0 6.1544839553579118 0 ;
...
createNode polyExtrudeFace -n "polyExtrudeFace2";
	...
	setAttr ".cbx" -type "double3" -3.6892585754394531 7.6544839553579118 2.5 ;
...
createNode polyExtrudeFace -n "polyExtrudeFace3";
	...
	setAttr ".rs" 42011;
	setAttr ".lt" -type "double3" 8.7899276304583624e-016 -1.0040101752371508e-015 2.0827370397720024 ;
	setAttr ".c[0]"  0 1 1;
...
createNode polyExtrudeFace -n "polyExtrudeFace8";
	...
	setAttr ".pvt" -type "float3" -9.4205761 7.2278628 0 ;
	setAttr ".rs" 53502;
	setAttr ".lt" -type "double3" -0.32572721584038783 -2.0400390627341512e-016 0.80265956754416323 ;
	setAttr ".c[0]"  0 1 1;
...
createNode polyExtrudeFace -n "polyExtrudeFace10";
	...
	setAttr ".rs" 59737;
	setAttr ".lt" -type "double3" 1.6653345369377348e-015 1.360594467820564e-016 0.85106514783299514 ;
	setAttr ".c[0]"  0 1 1;
...
createNode polyExtrudeFace -n "polyExtrudeFace11";
	...
	setAttr ".c[0]"  0 1 1;
	setAttr ".cbn" -type "double3" -11.722681045532227 7.8263377361043718 -0.52778023481369019 ;
	setAttr ".cbx" -type "double3" -11.677064895629883 8.697351854298951 0.52778023481369019 ;
...
createNode polyExtrudeFace -n "polyExtrudeFace12";
	...
	setAttr ".c[0]"  0 1 1;
	setAttr ".tk" -4.4000000953674316;
	setAttr ".cbn" -type "double3" -10.17252254486084 5.5077258758291032 -1.0611056089401245 ;
...
createNode polyExtrudeFace -n "polyExtrudeFace13";
	...
	setAttr ".rs" 35505;
	setAttr ".lt" -type "double3" -4.1240966671341377e-016 -2.6645352591003757e-015 
		5.8573280213345207 ;
	setAttr ".c[0]"  0 1 1;
...
createNode polyTweak -n "polyTweak13";
	setAttr ".uopa" yes;
	setAttr -s 18 ".tk";
	setAttr ".tk[102]" -type "float3" -1.8092519 0 0 ;
	setAttr ".tk[103]" -type "float3" -1.8092519 0 0 ;
	setAttr ".tk[104]" -type "float3" -1.8092519 0 0 ;
	setAttr ".tk[105]" -type "float3" -1.8092519 0 0 ;
	setAttr ".tk[106]" -type "float3" -1.8092519 0 0 ;
	setAttr ".tk[107]" -type "float3" -1.8092519 0 0 ;
	setAttr ".tk[108]" -type "float3" -1.8092519 0 0 ;
	setAttr ".tk[109]" -type "float3" -1.8092519 0 0 ;
